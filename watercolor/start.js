(() => {
  ...
  function run() {
    ...
    let previousPoint = {};
    canvas.addEventListener("mouseenter", createMouseEnterHandler(previousPoint));
    canvas.addEventListener("mousemove", createMouseMoveHandler(context, previousPoint));
  }
  run();
})();
